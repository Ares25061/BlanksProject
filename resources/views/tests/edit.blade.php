                ...
                <div class="grid md:grid-cols-2 xl:grid-cols-4 gap-4">
                    ...
                    <div class="composer-field">
                        ...
                        <input id="variant_count" type="number" min="1" max="10"
                               class="w-full px-4 py-3 rounded-2xl border border-slate-300 focus:ring-2 focus:ring-sky-500 focus:border-sky-500">
                        <p class="composer-field-hint text-xs text-slate-500 mt-2 dark:text-slate-400">До 10 вариантов. Уже выпущенные бланки сохранят свои номера вариантов.</p>
                    </div>
                    ...
                    <div class="composer-field">
                        ...
                        <p class="composer-field-hint text-xs text-slate-500 mt-2 dark:text-slate-400">В электронном и совмещённом режиме тест можно запускать по группе и проходить по ссылке или коду.</p>
                    </div>
                </div>
            </section>
